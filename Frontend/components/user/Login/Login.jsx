...
import { postLoginAPI } from '../../../lib/api/user';
    ...
    <div className={styles['login']}>
      <div className={styles['wrapper']}>
        <div className={styles['right']}>
          <input type="text" id="userId" value={userId} onChange={userIdChangeHandler} placeholder="UserId" />
          <input type="password" id="pw" value={pw} onChange={pwChangeHandler} placeholder="Password" />
